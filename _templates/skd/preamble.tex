...
\def\cdrlNum{${cdrlNum}}
\def\icsVersion{${icsVersion}}
\def\companyProject{${companyProject}}
...
\newcommand{\revisionhistory}{
  \renewcommand\cellalign{tl}
    \begin{center}
        ...
        \smallskip
        \begin{longtable}[c]{ | p{2.5in} | p{1.0in} | p{0.5in} | p{3.0in} | }
        \hline
            \multicolumn{1}{|c|}{\rule{0pt}{10pt}\textbf{Date}} &
            \multicolumn{1}{c|}{\rule{0pt}{10pt}\textbf{CN\#}} &
            \multicolumn{1}{c|}{\rule{0pt}{10pt}\textbf{Rev.}} &
            \multicolumn{1}{c|}{\rule{0pt}{10pt}\textbf{Description}} \\
        \hline
        \endfirsthead
